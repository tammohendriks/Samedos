...
const qualifikationen = [
  // Facharzt
  { titel: 'Facharzt für Arbeitsmedizin',   titelEN: 'Specialist in Occupational Medicine', institution: 'Ärztekammer Hamburg',        ort: 'Hamburg',  jahr: 2004, kategorie: 'facharzt',      offshoreRelevant: true,  bgmRelevant: true,  vorsorgeRelevant: true,  psychologieRelevant: true  },
  { titel: 'Facharzt für Allgemeinmedizin', titelEN: 'Specialist in General Medicine',      institution: 'Ärztekammer Niedersachsen',  ort: 'Hannover', jahr: 2002, kategorie: 'facharzt',      offshoreRelevant: true,  bgmRelevant: true,  vorsorgeRelevant: true,  psychologieRelevant: true  },

  // Zusatzqualifikationen
  { titel: 'Sportmedizin',                                                       titelEN: 'Sports Medicine',                                            institution: 'Ärztekammer Hamburg',        ort: 'Hamburg',   jahr: 2004, kategorie: 'zusatz',        offshoreRelevant: true,  bgmRelevant: false, vorsorgeRelevant: true,  psychologieRelevant: false },
  { titel: 'Manuelle Medizin / Chirotherapie',                                   titelEN: 'Manual Medicine / Chirotherapy',                             institution: 'Ärztekammer Niedersachsen',  ort: 'Hannover',  jahr: 2010, kategorie: 'zusatz',        offshoreRelevant: false, bgmRelevant: false, vorsorgeRelevant: true,  psychologieRelevant: false },
  { titel: 'Zusatzbezeichnung Qualitätsmanagement',                              titelEN: 'Additional qualification in Quality Management',             institution: 'Ärztekammer Niedersachsen',  ort: 'Hannover',  jahr: 2002, kategorie: 'zusatz',        offshoreRelevant: false, bgmRelevant: true,  vorsorgeRelevant: false, psychologieRelevant: false },
  { titel: 'Arbeitsmedizinische Zusammenhangsbegutachtung',                      titelEN: 'Occupational Causation Assessment',                          institution: 'DGAUM',                      ort: 'Düsseldorf', jahr: 2006, kategorie: 'zusatz',       offshoreRelevant: false, bgmRelevant: true,  vorsorgeRelevant: true,  psychologieRelevant: true  },
  { titel: 'Certified Disability Management Professional (CDMP)',                titelEN: 'Certified Disability Management Professional (CDMP)',        institution: 'IDMSC',                      ort: 'Köln',      jahr: 2005, kategorie: 'zusatz',        offshoreRelevant: false, bgmRelevant: true,  vorsorgeRelevant: false, psychologieRelevant: true  },
  { titel: 'Personzentrierter / Systemischer Coach',                             titelEN: 'Person-centred / Systemic Coach',                            institution: 'Der W.E.G. e.V.',            ort: 'Bremen',    jahr: 2013, kategorie: 'zusatz',        offshoreRelevant: false, bgmRelevant: true,  vorsorgeRelevant: false, psychologieRelevant: true  },
  { titel: 'Psychologischer Berater',                                            titelEN: 'Psychological Counsellor',                                   institution: 'Der W.E.G. e.V.',            ort: 'Bremen',    jahr: 2010, kategorie: 'zusatz',        offshoreRelevant: false, bgmRelevant: true,  vorsorgeRelevant: false, psychologieRelevant: true  },
  { titel: 'Fachkunde im Strahlenschutz (Notfalldiagnostik)',                     titelEN: 'Radiation Protection Expertise (Emergency Diagnostics)',     institution: 'Landesärztekammer Hessen',   ort: 'Frankfurt', jahr: 1999, kategorie: 'zusatz',        offshoreRelevant: true,  bgmRelevant: false, vorsorgeRelevant: true,  psychologieRelevant: false },
  { titel: 'Rettungsdienst',                                                     titelEN: 'Emergency Medical Service',                                  institution: 'Landesärztekammer Hessen',   ort: 'Frankfurt', jahr: 1999, kategorie: 'zusatz',        offshoreRelevant: true,  bgmRelevant: false, vorsorgeRelevant: true,  psychologieRelevant: false },

  // Ermächtigung
  { titel: 'Ermächtigung zur Überwachung beruflich strahlenexponierter Personen', titelEN: 'Authorisation to monitor occupationally radiation-exposed individuals', institution: 'Ärztekammer Bremen',        ort: 'Bremen',    jahr: 2013, kategorie: 'ermaechtigung', offshoreRelevant: true,  bgmRelevant: false, vorsorgeRelevant: true,  psychologieRelevant: false },

  // Ausbildung
  { titel: 'Approbation als Arzt',                                               titelEN: 'Medical Licence (Approbation)',                              institution: 'Landesprüfungsamt für Heilberufe', ort: 'Hannover', jahr: 1998, kategorie: 'ausbildung', offshoreRelevant: false, bgmRelevant: false, vorsorgeRelevant: false, psychologieRelevant: false },

  // Promotion
  { titel: 'Promotion zum Dr. med.',                                             titelEN: 'Doctorate (Dr. med.)',                                       institution: 'Medizinische Fakultät der Georg-August-Universität Göttingen', ort: 'Göttingen', jahr: 1997, kategorie: 'promotion',   offshoreRelevant: false, bgmRelevant: false, vorsorgeRelevant: false, psychologieRelevant: false },
